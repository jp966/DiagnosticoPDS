...
public class PruebaDiagnosticoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PruebaDiagnostico";
	...
	private PruebaDiagnosticoPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PruebaDiagnosticoPersistentManager();
		}
