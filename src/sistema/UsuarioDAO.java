...
public class UsuarioDAO {
	...
	public static boolean save(Usuario usuario) throws PersistentException {
		try {
			PruebaDiagnosticoPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Usuario usuario) throws PersistentException {
		try {
			PruebaDiagnosticoPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Usuario usuario) throws PersistentException {
		try {
			PruebaDiagnosticoPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Usuario usuario) throws PersistentException {
		try {
			PruebaDiagnosticoPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
